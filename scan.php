...
<a href="/logout " class="btn btn-danger pull-right pl-3">
   <i class="material-icons mr-2">exit_to_app</i>
   Logout
</a>
<!-- variable this->endSection() -->

<!-- variable this->section('content') -->
            ...
            <div class="col-lg-6 col-xxl-5 order-1 order-lg-2">
               <div class="card">
                  <div class="col-10 mx-auto card-header card-header-primary">
                     <div class="row">
                        <div class="col-md-6">
                           <h4 class="card-title"><b>Absen <!-- variable waktu --></b></h4>
                           <p class="card-category text-nowrap">Silahkan tunjukkan QR Code anda</p>
                        </div>
                        <div class="col-md-6 d-flex justify-content-center justify-content-md-end">
                           <a href="scan/$oppBtn" class="btn btn-<!-- variable oppBtn == 'masuk' ? 'success' : 'warning' --> px-3">
                              Absen <!-- variable oppBtn -->
                           </a>
                        </div>
                     </div>
                  </div>
