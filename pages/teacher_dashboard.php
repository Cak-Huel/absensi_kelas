            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="text-center">
                    Silahkan hubungi administrator untuk penugasan kelas.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <h3 class="card-title">
                    <!-- variable kelas['tingkat'] . ' ' . $kelas['jurusan'] . ' ' . $kelas['index_kelas'] -->
                  </h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">person</i> Total Siswa:
                    <!-- variable summary['total_siswa'] -->
                    <span class="mx-2">|</span>
                    <i class="material-icons text-primary">qr_code</i>
                    <a class="text-primary" href="teacher/qr">Download QR Code Siswa</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">
                    <b>Statistik Kehadiran Kelas Hari Ini</b>
                  </h4>
                  <p class="card-category">123</p>
                </div>
                <div class="card-body">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-info">
                  <h4 class="card-title">
                    Tingkat Kehadiran Kelas (7 Hari Terakhir)
                  </h4>
                  <p class="card-category">
                    Statistik kehadiran siswa per status
                  </p>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a class="text-info" href="teacher/laporan">Download Laporan</a>
                  </div>
                </div>
              </div>
            </div>
