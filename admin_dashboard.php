    ...
    -->
        <div class="logo">
          <a class="simple-text logo-normal">
            ...
            <br />
            <small><!-- variable generalSettings->school_name --></small>
          </a>
        </div>
                ...
                <li class="nav-item dropdown">
                  ...
                  >
                    ...
                    <a class="dropdown-item" href="#">
                      Role:
                      <span
                        class="h6 text-capitalize ml-2 my-auto badge badge-<?= is_superadmin() ? 'danger' : 'success'; ?>"
                      >
                        123
                      </span>
                    </a>
          ...
          <div class="container-fluid">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  <div class="card-header card-header-primary card-header-icon">
                    <div class="card-icon">
                      <a href="admin/siswa" class="text-white">
                        <i class="material-icons">person</i>
                      </a>
                    </div>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  <div class="card-header card-header-success card-header-icon">
                    <div class="card-icon">
                      <a href="admin/guru" class="text-white">
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  <div class="card-header card-header-info card-header-icon">
                    <div class="card-icon">
                      <a href="admin/kelas" class="text-white">
                        <i class="material-icons">grade</i>
                      </a>
                    </div>
                    <p class="card-category">Kelas / Jurusan</p>
                    <h3 class="card-title text-nowrap">123</h3>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <i class="material-icons">home</i>
                      <!-- variable generalSettings->school_name -->
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                  <div class="card-header card-header-danger card-header-icon">
                    <div class="card-icon">
                      <a href="admin/petugas" class="text-white">
              ...
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-header card-header-primary">
                    ...
                    >
                      <div>
                        ...
                        <p class="card-category"><!-- variable dateNow --></p>
                      </div>
                      <!-- FILTER KELAS -->
                      <div class="text-right">
                        <div
                  ...
                  <div class="card-body" id="siswaStatsContainer">
                    <?= view('admin/_dashboard_siswa_stats', [ 'hadir' =>
                    $jumlahKehadiranSiswa['hadir'], 'sakit' =>
                    $jumlahKehadiranSiswa['sakit'], 'izin' =>
                    $jumlahKehadiranSiswa['izin'], 'alfa' =>
                    $jumlahKehadiranSiswa['alfa'], 'totalSiswa' => $totalSiswa
                    ]) ?>
                  </div>
                </div>
              </div>
                    ...
                    <div class="row text-center flex-nowrap">
                      <div class="col-2">
                        ...
                        <h4 class="text-nowrap">
                          <!-- variable jumlahKehadiranGuru['hadir'] -->
                        </h4>
                      </div>
                      <div class="col-2">
                        <h5 class="text-warning text-nowrap"><b>Sakit</b></h5>
                        <h4 class="text-nowrap">
                          <!-- variable jumlahKehadiranGuru['sakit'] -->
                        </h4>
                      </div>
                      <div class="col-2">
                        <h5 class="text-info text-nowrap"><b>Izin</b></h5>
                        <h4 class="text-nowrap">
                          <!-- variable jumlahKehadiranGuru['izin'] -->
                        </h4>
                      </div>
                      <div class="col-2">
                        <h5 class="text-danger text-nowrap"><b>Alfa</b></h5>
                        <h4 class="text-nowrap">
                          <!-- variable jumlahKehadiranGuru['alfa'] -->
                        </h4>
                      </div>
                      <div class="col-1">
                        <div
                      ...
                      <div class="col-2 col-sm-3">
                        ...
                        <h4 class="text-nowrap"><!-- variable totalGuru --></h4>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="card">
                  <div class="card-header card-header-primary">
                    <h4 class="card-title" id="titleSiswaChart">
                  ...
                  <div class="card-footer">
                    <div class="stats">
                      ...
                      <a class="text-primary" href="admin/absen-siswa"
                        >Lihat data</a
                      >
                    </div>
                  </div>
                ...
                <div class="card">
                  ...
                  <div class="card-footer">
                    <div class="stats">
                      ...
                      <a class="text-success" href="admin/absen-guru"
                        >Lihat data</a
                      >
                    </div>
                  </div>
        ...
        <footer class="footer">
          <div class="container-fluid">
            ...
            <div class="copyright float-right">
              <!-- variable generalSettings->copyright -->
            </div>
          </div>
        </footer>
    ...
    <script>
      ...
      function initDashboardPageCharts() {
        ...
        if (siswaCtx) {
          ...
          kehadiranSiswaChart = new Chart(
            siswaCtx,
            createChartConfig(dataSiswa),
          );
        }
